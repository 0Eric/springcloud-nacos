 ...
 */
@ApiModel(value = "交通预警 ds_traffic_warning")
public class DsTrafficWarningDto implements Serializable {
     ...
     * 道路名称
     */
    @ApiModelProperty(value = "道路名称", name = "roadCodeName", dataType = "String")
     ...
     * 道路分段名称
     */
    @ApiModelProperty(value = "道路分段名称", name = "roadSectionName", dataType = "String")
